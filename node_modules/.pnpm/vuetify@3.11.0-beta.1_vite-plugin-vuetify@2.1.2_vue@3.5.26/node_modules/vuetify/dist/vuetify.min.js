...
let h,y="",b=-1
const V=t.computed(()=>e.hideSelected?u.value.filter(t=>!v.value.some(a=>(e.valueComparator||St)(a,t))):u.value),w=t.computed(()=>e.hideNoData&&!V.value.length||m.isReadonly.value||m.isDisabled.value),k=la(e,"menu"),S=t.computed({get:()=>k.value,set:e=>{k.value&&!e&&i.value?.ΨopenChildren.size||e&&w.value||(k.value=e)}}),{menuId:x,ariaExpanded:N,ariaControls:C,ariaLabel:E}=Qi(e,S),I=t.computed(()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}})),_=t.ref(),P=Xi(_,r)
function A(t){e.openOnClear&&(S.value=!0)}function T(){w.value||(S.value=!S.value)}function R(e){ue(e)&&D(e)}function D(t){if(!t.key||m.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"," "].includes(t.key)&&(S.value=!0),["Escape","Tab"].includes(t.key)&&(S.value=!1),"Home"===t.key?_.value?.focus("first"):"End"===t.key&&_.value?.focus("last")
if(!ue(t))return
...
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(oo,{key:n.value,modelValue:l,ripple:!1,tabindex:"-1",onClick:e=>e.preventDefault()},null):void 0,i.prependAvatar&&t.createVNode(qn,{image:i.prependAvatar},null),i.prependIcon&&t.createVNode(Jl,{icon:i.prependIcon},null)])}})}}),l["append-item"]?.()]})]}),v.value.map((n,o)=>{function r(e){e.stopPropagation(),e.preventDefault(),F(n,!1)}const i=t.mergeProps(Zo.filterProps(n.props),{"onClick:close":r,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),r(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0}),s=a?!!l.chip:!!l.selection,u=s?re(a?l.chip({item:n,index:o,props:i}):l.selection({item:n,index:o})):void 0
...
return t.createElementVNode(t.Fragment,null,[l["append-inner"]?.(...n),e.menuIcon?t.createVNode(Jl,{class:"v-select__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon},null):void 0])}})}),ko({isFocused:g,menu:S,select:F},r)}}),as=(e,t,a)=>{if(null==e||null==t)return-1
...
function Au(e){const{times:a}=function(e){const a=t.reactive({now:zs("0000-00-00 00:00",!0),today:zs("0000-00-00",!0)}),l=t.computed(()=>e.now&&Ms(e.now)?zs(e.now,!0):null)
...
r(e,a.now),i(e,a.now),r(e,a.today)}return t.watch(l,s),s(),n(),{times:a,parsedNow:l,updateTimes:s,setPresent:n,getNow:o,updateDay:r,updateTime:i}}({now:e.now}),l=fa(e),n=_u(),o=t.computed(()=>"month"===e.type?Bs(zs(e.start,!0)):zs(e.start,!0)),r=t.computed(()=>{const t=o.value,a=e.end&&zs(e.end)||t,l=Ws(a)<Ws(t)?t:a
return"month"===e.type?Ds(l):l}),i=t.computed(()=>Ms(e.modelValue)?zs(e.modelValue,!0):o.value||a.today),s=t.computed(()=>{const t=Array.isArray(e.weekdays)?e.weekdays:(e.weekdays||"").split(",").map(e=>parseInt(e,10)),a=n.toJsDate(n.startOfWeek(n.date(),e.firstDayOfWeek)).getDay()
return[...t.toSorted().filter(e=>e>=a),...t.toSorted().filter(e=>e<a)]}),u=t.computed(()=>{const t=i.value,a=parseInt(String(e.categoryDays))||1
...
default:return s.value}}),c=t.computed(()=>function(e){const t=[1,1,1,1,1,1,1],a=[0,0,0,0,0,0,0]
for(let t=0;t<e.length;t++)a[e[t]]=1
for(let e=0;e<7;e++){let l=1
for(let t=1;t<7&&!a[(e+t)%7];t++)l++
t[e]=a[e]*l}return t}(s.value)),d=t.computed(()=>ru(o.value,r.value,a.today,c.value)),v=t.computed(()=>e.dayFormat?e.dayFormat:iu(l.current.value,()=>({timeZone:"UTC",day:"numeric"}))),p=t.computed(()=>e.weekdayFormat?e.weekdayFormat:iu(l.current.value,(e,t)=>({timeZone:"UTC",weekday:t?"short":"long"})))
return{times:a,locale:l,parsedValue:i,parsedWeekdays:s,effectiveWeekdays:u,weekdaySkips:c,parsedStart:o,parsedEnd:r,days:d,dayFormatter:v,weekdayFormatter:p,getColorProps:function(e){return vl(e)},getRelativeClasses:function(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
return{"v-present":e.present,"v-past":e.past,"v-future":e.future,"v-outside":t}},getWeekNumber:function(t){return n.getWeek(n.date(t.date),e.firstDayOfWeek,e.firstDayOfYear)},getStartOfWeek:function(e){return function(e,t,a){const l=Zs(e)
return nu(l,t[0],au),qs(l),a&&Hs(l,a,l.hasTime),l}(e,s.value,a.today)},getEndOfWeek:function(e){return function(e,t,a){const l=Zs(e)
return nu(l,t[t.length-1]),qs(l),a&&Hs(l,a,l.hasTime),l}(e,s.value,a.today)},getFormatter:function(e){return iu(l.current.value,()=>e)}}}const Tu=vt({maxDays:{type:Number,default:7},intervalHeight:{type:[Number,String],default:48,validate:Fs},intervalWidth:{type:[Number,String],default:60,validate:Fs},intervalMinutes:{type:[Number,String],default:60,validate:Fs},firstInterval:{type:[Number,String],default:0,validate:Fs},firstTime:{type:[Number,String,Object],validate:function(e){return"number"==typeof e&&isFinite(e)||!!As.exec(e)||"object"==typeof e&&isFinite(e.hour)&&isFinite(e.minute)}},intervalCount:{type:[Number,String],default:24,validate:Fs},intervalFormat:{type:Function,default:null},intervalStyle:{type:Function,default:null},showIntervalLabel:{type:Function,default:null}},"VCalendar-intervals")
...
return{mounted:n,updated:n,unmounted(e){t.render(null,e)}}}(Sg,e=>({activator:"parent",location:e.arg?.replace("-"," "),text:"boolean"==typeof e.value?void 0:e.value}))
...
if(a&&e in a)return a[e]}Hg.version="3.11.0-beta.1"
const Ug=function(){return Hg({components:Dg,directives:jg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Gg="3.11.0-beta.1"
